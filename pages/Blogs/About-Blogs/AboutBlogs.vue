...
export default {
  ...
  setup(props) {
    ...
    // İlk yüklemede varsayılan dili kullanarak veriyi çek
    onMounted(() => {
      fetchData(props.currentLocale);
    });

    // Dil değiştiğinde yeniden veri çekmek için watch kullanıyoruz
...
.project-grid {
  display: flex;
  flex-direction: column; /* Card'ları dikey hizalar */
...
.project-title {
  font-size: 1.5em; /* Başlığı büyüt */
}

.project-desc {
  font-size: 1.1em; /* Açıklama yazısını büyüt */
}
