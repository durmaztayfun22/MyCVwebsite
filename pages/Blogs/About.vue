...
export default {
  ...
  setup() {
    ...
    const p1 = ref("");
    const p2 = ref("");
    const currentLocale = ref("en"); // Varsayılan dil
    ...
    // Dil değiştiğinde güncelleme yap
    ...
    return {
      ...
      p2,
      updateLanguage,
      currentLocale, // Prop olarak `AboutBlogs.vue`'a gönderiyoruz
    };
  },
};
</script>
...
.about-image {
  ...
  position: relative; /* Added to position the overlay relative to this container */
}
